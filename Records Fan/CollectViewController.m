...
- (id) init
{
    self = [super init];
    if (self) {
        UITabBarItem *itemCollect = [[UITabBarItem alloc] initWithTitle:@"自选集" image:[UIImage imageNamed:@"collect"] selectedImage:[UIImage imageNamed:@"collect_sel"]];
        [self setTabBarItem:itemCollect];
        ...
        [self setTitle:itemCollect.title];
    }
    return self;
}
